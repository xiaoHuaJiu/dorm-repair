...
class Plan7ContractTest {
  ...
  @Test void reworkValidation(){assertThat(validator.validate(new CreateReworkRequest(" ",null))).isNotEmpty();assertThat(validator.validate(new CreateReworkRequest("返工",Collections.nCopies(10,"a")))).isNotEmpty();assertThat(validator.validate(new CreateReworkRequest("返工",List.of(" ")))).isNotEmpty();assertThat(validator.validate(new CreateReworkRequest("返工",List.of("repair/a.jpg")))).isEmpty();}
}
