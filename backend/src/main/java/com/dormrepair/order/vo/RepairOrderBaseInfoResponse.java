...
public record RepairOrderBaseInfoResponse(
    ...
    public static RepairOrderBaseInfoResponse from(RepairOrder order, boolean includeAdminFields) {
        return new RepairOrderBaseInfoResponse(
            ...
            order.getFaultTypeId(), order.getProblemDescription(), order.getImageUrls(), order.getStatus(),
