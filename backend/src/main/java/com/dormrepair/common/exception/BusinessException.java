    ...
    private static HttpStatus defaultStatus(ResultCodeEnum resultCode) {
        return switch (resultCode) {
            ...
            case DATA_NOT_FOUND, USER_NOT_FOUND, FAULT_NOT_FOUND, AREA_NOT_FOUND, FILE_NOT_FOUND,
                WORKER_NOT_FOUND, SCHEDULE_NOT_FOUND, ORDER_NOT_FOUND, TRANSFER_NOT_FOUND -> HttpStatus.NOT_FOUND;
            case ORDER_ACCESS_DENIED, FILE_NOT_OWNER -> HttpStatus.FORBIDDEN;
            case DATA_CONFLICT, USERNAME_EXISTS, FAULT_CODE_EXISTS, AREA_DUPLICATE, AREA_CODE_EXISTS,
                WORKER_NO_EXISTS, WORKER_USER_EXISTS, SCHEDULE_CONFLICT,
                ORDER_IDEMPOTENT_PROCESSING, ORDER_BIZ_NO_CONFLICT, ORDER_EVALUATION_EXISTS, FILE_ALREADY_BOUND,
                TRANSFER_STATE_INVALID, TRANSFER_PENDING_EXISTS, TRANSFER_ALREADY_REVIEWED, TRANSFER_ORDER_CHANGED,
                TRANSFER_BIZ_NO_CONFLICT -> HttpStatus.CONFLICT;
